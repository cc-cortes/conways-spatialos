...
public partial struct ComponentInterest : global::System.IEquatable<ComponentInterest>, global::Improbable.Collections.IDeepCopyable<ComponentInterest>
{
  ...
  public static class Query_Internal
  {
    public static unsafe void Write(global::Improbable.Worker.Internal.GcHandlePool _pool,
                             Query _data, global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      {
        global::Improbable.ComponentInterest.QueryConstraint_Internal.Write(_pool, _data.constraint, _obj.AddObject(1));
      }
      if (_data.fullSnapshotResult.HasValue)
      {
        _obj.AddBool(2, _data.fullSnapshotResult.Value);
      }
      if (_data.resultComponentId != null)
      {
        for (int _i = 0; _i < _data.resultComponentId.Count; ++_i)
        {
          _obj.AddUint32(3, _data.resultComponentId[_i]);
        }
      }
      if (_data.frequency.HasValue)
      {
        _obj.AddFloat(4, _data.frequency.Value);
      }
    }

    public static unsafe Query Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      Query _data;
      {
        _data.constraint = global::Improbable.ComponentInterest.QueryConstraint_Internal.Read(_obj.GetObject(1));
      }
      {
        var _count = _obj.GetBoolCount(2);
        if (_count > 0)
        {
          _data.fullSnapshotResult = new global::Improbable.Collections.Option<bool>(_obj.GetBool(2));
        }
        else
        {
      ...
      {
        var _count = _obj.GetUint32Count(3);
        _data.resultComponentId = new global::Improbable.Collections.List<uint>((int) _count);
        for (uint _i = 0; _i < _count; ++_i)
        {
          _data.resultComponentId.Add(_obj.IndexUint32(3, _i));
        }
      }
      {
        var _count = _obj.GetFloatCount(4);
        if (_count > 0)
        {
          _data.frequency = new global::Improbable.Collections.Option<float>(_obj.GetFloat(4));
        }
        else
        {
  ...
  {
    public static unsafe void Write(global::Improbable.Worker.Internal.GcHandlePool _pool,
                             SphereConstraint _data, global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      {
    ...
    public static unsafe SphereConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      SphereConstraint _data;
      {
        _data.center = global::Improbable.Coordinates_Internal.Read(_obj.GetObject(1));
      }
      {
        _data.radius = _obj.GetDouble(2);
      }
      return _data;
    }
  }
  ...
  public static class CylinderConstraint_Internal
  {
    ...
    public static unsafe CylinderConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
  ...
  public static class BoxConstraint_Internal
  {
    ...
    public static unsafe BoxConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      BoxConstraint _data;
      {
        _data.center = global::Improbable.Coordinates_Internal.Read(_obj.GetObject(1));
      ...
      {
        _data.edgeLength = global::Improbable.EdgeLength_Internal.Read(_obj.GetObject(2));
      }
      return _data;
    }
  }
  ...
  {
    public static unsafe void Write(global::Improbable.Worker.Internal.GcHandlePool _pool,
                             RelativeSphereConstraint _data, global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      {
    ...
    public static unsafe RelativeSphereConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      RelativeSphereConstraint _data;
      {
        _data.radius = _obj.GetDouble(1);
      }
      return _data;
    }
  }
  ...
  public static class RelativeCylinderConstraint_Internal
  {
    ...
    public static unsafe RelativeCylinderConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
  ...
  public static class RelativeBoxConstraint_Internal
  {
    ...
    public static unsafe RelativeBoxConstraint Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
    {
      RelativeBoxConstraint _data;
      {
        _data.edgeLength = global::Improbable.EdgeLength_Internal.Read(_obj.GetObject(1));
      }
      return _data;
    }
  }
...
{
  public static unsafe void Write(global::Improbable.Worker.Internal.GcHandlePool _pool,
                           ComponentInterest _data, global::Improbable.Worker.CInterop.SchemaObject _obj)
  {
    if (_data.queries != null)
    {
      for (int _i = 0; _i < _data.queries.Count; ++_i)
      {
        global::Improbable.ComponentInterest.Query_Internal.Write(_pool, _data.queries[_i], _obj.AddObject(1));
      }
    }
  }

  public static unsafe ComponentInterest Read(global::Improbable.Worker.CInterop.SchemaObject _obj)
  {
    ComponentInterest _data;
    {
      ...
      for (uint _i = 0; _i < _count; ++_i)
      {
        _data.queries.Add(global::Improbable.ComponentInterest.Query_Internal.Read(_obj.IndexObject(1, _i)));
      }
    }
    return _data;
  }
